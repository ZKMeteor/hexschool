<template>
  ...
  <div class="container-fluid box">
    ...
    <ProductModal ref="ProductModal" :product="tempProduct" @update-Product="updataProduct"></ProductModal>
    <delProductModal ref="delProductModal" :delproduct="tempProduct" @delProductModal="delProductModal"></delProductModal>
  </div>
</div>
</template>
